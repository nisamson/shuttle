...
public class GameResult : IEntityConvertible<GameResult, Api.Models.Index.V1.GameResult> {
    ...
    public static GameResult From(Api.Models.Index.V1.GameResult original) {
        return new() {
    ...
    public Api.Models.Index.V1.GameResult To() {
        return new(
                GameId,
                Season,
                LeagueId,
    ...
    public void UpdateFrom(Api.Models.Index.V1.GameResult target) {
